...
namespace WallFinishByCategory_v1
{
    ...
    public class StartPluginCommand : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            Document docNow = uidoc.Document;
            //doc.GetLin

            //DocumentSet fdsf = uiapp.Application.Documents;
            ...
            //open user window
            UserWindow userWindow = new UserWindow(commandData, doc, docNow, worksharedStatus, allRooms, wallType);
